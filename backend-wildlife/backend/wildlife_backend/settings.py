"""
Django settings for wildlife_backend project.
"""
...
ROOT_URLCONF = 'wildlife_backend.urls'
...
WSGI_APPLICATION = 'wildlife_backend.wsgi.application'
...
SWAGGER_SETTINGS = {
    ...
    'TAGS_SORTER': None,  # Keep workflow order instead of alphabetical
    'OPERATIONS_SORTER': None,  # Keep definition order
    'DOC_EXPANSION': 'list',
    'DEEP_LINKING': True,
