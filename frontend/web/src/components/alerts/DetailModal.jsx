    ...
    <div className="fixed inset-0 bg-black/60 backdrop-blur-sm z-50 flex items-center justify-center p-4" onClick={onClose}>
      <div className="bg-white rounded-3xl w-full max-w-4xl max-h-[90vh] overflow-y-auto shadow-2xl border border-gray-100" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="p-8">
          ...
          <div className="bg-gradient-to-br from-brand-primary/10 to-brand-secondary/10 rounded-2xl p-6 mb-6 border border-brand-primary/20">
            <h3 className="text-sm font-bold text-brand-primary uppercase tracking-wide mb-4">Movement Pattern (Last 24h)</h3>
            <div className="bg-white rounded-xl overflow-hidden border border-gray-200">
              <svg viewBox="0 0 400 200" className="w-full h-48">
                ...
                <circle cx="350" cy="140" r="12" fill="var(--brand-primary)" opacity="0.2">
                ...
                <circle cx="350" cy="140" r="8" fill="var(--brand-primary)" stroke="white" strokeWidth="2" />
          ...
          <div className="grid grid-cols-3 gap-4 mb-6">
            <div className="bg-brand-primary/10 border border-brand-primary/30 rounded-2xl p-4">
              <div className="flex items-center space-x-3 mb-2">
                <div className="w-10 h-10 bg-brand-primary/100 rounded-xl flex items-center justify-center">
                  <Heart className="w-5 h-5 text-white" />
                </div>
                <div>
                  <p className="text-xs text-brand-primary font-medium">Health Status</p>
                  <p className="text-lg font-bold text-brand-primary">{animal.health}</p>
                </div>
              </div>
            </div>
            ...
            <div className={`border rounded-2xl p-4 ${
              animal.battery > 50 ? 'bg-brand-primary/10 border-brand-primary/30' :
              ...
              <div className="flex items-center space-x-3 mb-2">
                ...
                <div>
                  <p className={`text-xs font-medium ${
                    animal.battery > 50 ? 'text-brand-primary' :
          ...
          <div className="mt-6 bg-brand-primary/10 border border-brand-primary/20 rounded-2xl p-6">
            <h3 className="text-sm font-bold text-brand-primary uppercase tracking-wide mb-4">Recent Activity</h3>
            <div className="space-y-3">
              {[
                ...
                <div key={idx} className="flex items-start space-x-3 p-3 bg-white rounded-lg">
                  <div className="w-8 h-8 bg-brand-primary/20 rounded-lg flex items-center justify-center flex-shrink-0">
                    <log.icon className="w-4 h-4 text-brand-primary" />
                  </div>
